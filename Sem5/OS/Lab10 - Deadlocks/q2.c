...
// Function for a customer to request resources
...
void *customer(void *arg) {
   ...
   int requests = 5; // Number of requests each customer will make
   ...
   while (requests > 0) {
       ...
       // Simulate delay before the next request
...
int main() {
   ...
   // Initialize maximum resources that each customer may request
